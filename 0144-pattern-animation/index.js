...
let container = d3.select('.container').style('--side-length', SIDE_LENGTH);
...
animation
  .to($horizontalSpan, 1, { rotation: 45 }, 'step1')
  .to($horizontalSpan, 1, { x: '-10px', y: '-10px' }, 'step2')
  .to(
    $horizontalSpan,
    1,
    { rotation: 0, x: '0', y: '0', scaleY: 2, scaleX: 0.5 },
    'step3'
  )
  .to($horizontalSpan, 1, { rotation: 90, scaleY: 1, scaleX: 1 }, 'step4');

animation
  .to($verticalSpan, 1, { rotation: 45 }, 'step1')
